...
class APIEndpoints:
    ...
    def hardware_options(self):
        ...
        try:
            ...
            # Add WM1303 LoRa concentrator option (SX1302/SX1303 HAL gateway)
            hardware_list.append(
                {
                    "key": "wm1303",
                    "name": "WM1303 LoRa Concentrator (SX1302/SX1303)",
                    "description": "Multi-channel LoRa gateway module - requires pyMC_WM1303",
                    "config": {},
                }
            )
    ...
    def setup_wizard(self):
        ...
        try:
            ...
            if hardware_key not in ("kiss", "wm1303"):
